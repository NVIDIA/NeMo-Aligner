#!/bin/bash
#SBATCH -N 4 --mem=0 --ntasks-per-node 8 -A llmservice_modelalignment_ppo --job-name llmservice_modelalignment_minitron:code -t 4:00:00 --exclusive --gpus-per-node=8 --partition=batch_block1,batch_block3,batch_block4
...
NAME="alex-code-minitron-sparse"
#COMMIT_ID=f5766ae
COMMIT_ID=302a621
...
TRAIN_DATA_PATH="/lustre/fsw/portfolios/llmservice/users/abukharin/data/minitron_code_train.jsonl"
VALID_DATA_PATH="/lustre/fsw/portfolios/llmservice/users/abukharin/data/minitron_code_val.jsonl"
