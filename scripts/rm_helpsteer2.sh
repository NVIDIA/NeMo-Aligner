...
# first run: lr=1e-6
NAME="rm_baseline_lr1e-6_bsz512-scale2.2"
COMMIT_ID=f3f9dc4
...
TRAIN_DATA_PATH="${DATASET_DIR}/helpsteer_2_official_train_comparisons.jsonl"
VALID_DATA_PATH="${DATASET_DIR}/helpsteer_2_official_val_comparisons.jsonl"
