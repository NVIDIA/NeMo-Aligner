...
#SBATCH -N 2
#SBATCH -t 4:00:00
#SBATCH -J llmservice_modelalignment_ppo-reward_model:hh
...
# first run: lr=1e-6
NAME="rm_baseline_lr1e-5_bsz512-helpsteer-ranking-official"
COMMIT_ID=f3f9dc4
...
TRAIN_DATA_PATH="${DATASET_DIR}/anthropic_hh_train_comparisons.jsonl"
VALID_DATA_PATH="${DATASET_DIR}/anthropic_hh_val_comparisons.jsonl"
...
&& python -u ${NEMO_RLHF_DIR}/examples/nlp/gpt/train_reward_model.py \
    ...
    trainer.rm.save_interval=18 \
    trainer.rm.val_check_interval=18 \
    trainer.rm.limit_val_batches=32 \
