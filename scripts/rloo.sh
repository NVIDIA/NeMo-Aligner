#!/bin/bash
#SBATCH -N 8 --ntasks-per-node 8 -A llmservice_modelalignment_ppo --job-name llmservice_modelalignment_rloo:42-9_critic+reward -t 4:00:00 --dependency singleton --exclusive --gpus-per-node=8 --partition=batch_block1,batch_block3,batch_block4
#SBATCH hetjob
...
NAME="ablation-eloirm-rloo-hh-lr1e-7-bsz64-kl0.01-test"
COMMIT_ID=770873d
