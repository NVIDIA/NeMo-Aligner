...
ACTOR_NEMO_FILE="/lustre/fsw/portfolios/llmservice/users/abukharin/checkpoints/llama3.1-8b-instruct.nemo"
DATASET_DIR="${RLHF_SHARED_DIR}/data/extra_id_prefix_end_with_backslash_n_extra_id_1_jsonl"
TRAIN_DATA_PATH="/lustre/fsw/portfolios/llmservice/users/abukharin/data/llama3_helpsteer_train.jsonl"
VALID_DATA_PATH="/lustre/fsw/portfolios/llmservice/users/abukharin/data/llama3_helpsteer_val.jsonl"
