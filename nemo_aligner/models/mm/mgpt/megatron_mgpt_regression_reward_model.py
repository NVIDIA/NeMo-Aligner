...
from nemo_aligner.models.mm.mgpt.megatron_mgpt_reward_model import MegatronMGPTRewardModel
from nemo_aligner.utils.train_utils import set_sync_funcs


class MegatronMGPTRegressionRewardModel(MegatronMGPTRewardModel):
    """
    ...
    def setup_optimizer_param_groups(self):
        ...
        if False:
            ...
            if True: #not self.ptuning_only_and_non_first_stage:
                opt_params = []
                ...
                for name, param in self._unwrap_model().named_parameters(prefix="model"):
                    if "rm_head" in name: # in self.tunable_base_param_keys:
                        print(f"Adding param: {name} to optimizer param group")
        ...
        def fwd_output_and_loss_func(dataloader_iter, model):
            ...
            if parallel_state.get_pipeline_model_parallel_world_size() == 1:
                ...
                if parallel_state.is_pipeline_first_stage():
                    required_keys.update(("inputs", "position_ids", "media"))
