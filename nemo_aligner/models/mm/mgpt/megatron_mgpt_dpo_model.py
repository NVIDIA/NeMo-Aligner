...
class MegatronMGPTDPOModel(MultimodalGPTModel, NLPAdapterModelMixin, SupervisedInterface):
    """
    ...
    def get_forward_output_and_loss_func(self, validation_step=False, logprobs_only=False):
        def fwd_output_and_loss_func(dataloader_iter, model, checkpoint_activations_all_layers=None):
            ...
            tokens, labels, ref_logprobs, gt_rewards, media = None, None, None, None, None
