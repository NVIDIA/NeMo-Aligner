...
from nemo_aligner.models.mm.mgpt.mgpt_reward_model import MultimodalGPTRewardModel
...
class MegatronMGPTRewardModel(MultimodalGPTModel, SupervisedInterface, Inferrable):
    ...
    def model_provider_func(self, pre_process, post_process):
        ...
        model = MultimodalGPTRewardModel(
        ...
        def fwd_output_and_loss_func(dataloader_iter, model):
            ...
            if parallel_state.get_pipeline_model_parallel_world_size() == 1:
                ...
                if parallel_state.is_pipeline_first_stage():
                    required_keys.update(("chosen", "rejected", "position_ids", "chosen_media", "rejected_media"))
            ...
            lengths, tokens, media = None, None, None
            position_ids = (
            ...
            if batch["chosen_media"] is not None and batch["rejected_media"] is not None:
    ...
    def infer(
        ...
        print("Calling infer, inputs", inputs)
        logging.warning(f"Calling infer, inputs: {inputs}")
