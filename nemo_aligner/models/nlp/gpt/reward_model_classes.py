...
from nemo_aligner.models.nlp.gpt.megatron_gpt_categorical_reward_model import MegatronGPTCategoricalRewardModel
...
REWARD_MODEL_CLASS_DICT = {
    ...
    RewardModelType.CATEGORICAL: MegatronGPTCategoricalRewardModel,
}
