...
from megatron.core.num_microbatches_calculator import (
    reconfigure_num_microbatches_calculator as reconfigure_microbatch_calculator,
)
...
def collate_with_batch_max_sequence_length(
    ...
    answer = [item["extra_verifier_info"] for item in data_batch]
    ...
    output = {"text": texts, "length": lengths, "idx": idx, "extra_verifier_info": answer, "dataset": dataset}
...
def log_memory(prefix):
    ...
    print(f"Mem Usage | {prefix} | pytorch:{pyt} total_occupied:{el} | memory_other_than_pyt:{el-pyt}")
