...
from nemo_aligner.data.mm.datasets import dpo_custom_collate
from nemo_aligner.data.mm.builders import build_train_valid_test_dpo_datasets
from nemo_aligner.models.mm.mgpt.megatron_mgpt_dpo_model import MegatronMGPTDPOModel
...
@hydra_runner(config_path="conf", config_name="mgpt_dpo")
def main(cfg) -> None:
