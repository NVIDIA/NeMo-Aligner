...
from nemo_aligner.utils.deep_search.mcts.feedback_functions import DummyScore, GSK8KFeedbackDataset, HelpSteerFeedback, SteerLMFeedback
...
def main(cfg) -> None:
    ...
    search_func = partial(
        ...
        ptl_model=ptl_model,
        score_fn=score_fn,
        eos_id=ptl_model.tokenizer.tokenizer.eos_id(),
        bos_id=ptl_model.tokenizer.tokenizer.bos_id(),
        pad_id=ptl_model.tokenizer.tokenizer.pad_id(),
