...
def main(cfg) -> None:
    ...
    train_dataloader = build_dataloader(
        ...
        collate_fn=bypass_collate_train if train_data_cfg.get("answer_only_loss", False) else train_ds.collate_fn,
    ...
    val_dataloader = build_dataloader(
        ...
        drop_last=val_data_cfg.drop_last if val_data_cfg.get("answer_only_loss", False) else validation_ds.collate_fn,
